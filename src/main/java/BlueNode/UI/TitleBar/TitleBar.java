package BlueNode.UI.TitleBar;

import BlueNode.Logging.BaseLogger;
import BlueNode.Logging.ELogLevel;
import BlueNode.UI.Components.ImageLoader;
import BlueNode.UI.TitleBar.Buttons.ControlButtons.ButtonPanel;
import BlueNode.UI.TitleBar.Buttons.FileButton;
import BlueNode.UI.TitleBar.Buttons.SettingsButton;
...
public class TitleBar extends BorderPane {
    ...
    public TitleBar(Stage pStage) {
        ...
        BaseLogger.log(ELogLevel.SUCCESS, "TitleBar has been created successfully");
    }
