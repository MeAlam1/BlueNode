...
- All class names should be PascalCase, starting with a capital letter.
    - **Example**: `ClassName`.

- All constants should be in uppercase, with words separated by underscores.
    - **Example**: `BACKGROUND_COLOR`.

- All package names should be in camelCase, starting with a lowercase letter.
    - **Example**: `com.mealam.bluenode`.
...
- **Example**:
  ...
  /**
     ...
     * <p>
     * <strong>TODO: Testing with multiple difficult equations to ensure it properly works.</strong><br>
...
1. **Fork the Repository**
    - Create a fork of the BlueNode repository to your GitHub account.

2. **Clone Your Fork**
    - Clone your forked repository to your local machine.
    - **Example**:
      ```bash
      git clone https://github.com/MeAlam1/BlueNode.git
      ```
...
You assign all rights, title, and interest in the copyright of your contributions to BlueNode. This allows BlueNode to enforce copyright and maintain the integrity of the project.
...
- You grant BlueNode the right to use, modify, and distribute your contribution under the MIT License.
- You agree to assign the copyright of your contribution to BlueNode.
...
Thank you for contributing to BlueNode and helping to make it better!
